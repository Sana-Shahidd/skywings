...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-quote strong { color: var(--gold); font-style: normal; }
        /* Right Panel */
        .login-right {
            flex: 1;
        ...
        @media (max-width: 768px) {
            ...
            .login-right { border: 1px solid var(--gold); }
        }
    </style>
</head>
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            <div class="login-brand">✈ SKYWINGS</div>
            <div>
                <p class="login-quote">
                    "Travel is the only thing you buy that makes you
                    <strong>richer.</strong> Welcome back to your
                    premium journey."
                </p>
            </div>
        </div>
